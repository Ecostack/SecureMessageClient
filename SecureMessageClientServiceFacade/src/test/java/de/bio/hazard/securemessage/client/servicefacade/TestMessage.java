...
public class TestMessage extends TestCase {
    ...
    public void testMessage() throws NoSuchAlgorithmException, NoSuchProviderException, MessageExceptionBiohazard {
	authenticationService = new AuthenticationService();
	basisInfoService = new BasisInfoService();
	userService = new UserService();
	messageService = new MessageService();
	asymmetricKeygen = new AsymmetricKeygen();
